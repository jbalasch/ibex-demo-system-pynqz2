## Based on https://dpoauwgwqsy2x.cloudfront.net/Download/pynq-z2_v1.0.xdc.zip
...
set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { IO_CLK }]; #IO_L13P_T2_MRCC_35 Sch=sysclk
...
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS33 } [get_ports { IO_RST }]; #IO_L9P_T1_DQS_AD3P_35 Sch=btn[3]

##PmodA

set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { GPIOS[0] }]; #IO_L17P_T2_34 Sch=ja_p[1]
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { GPIOS[1] }]; #IO_L17N_T2_34 Sch=ja_n[1]
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { GPIOS[2] }]; #IO_L7P_T1_34 Sch=ja_p[2]
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { GPIOS[3] }]; #IO_L7N_T1_34 Sch=ja_n[2]
...
set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 } [get_ports { SPI_RX }]; #IO_L10N_T1_34 Sch=miso
set_property -dict { PACKAGE_PIN T12   IOSTANDARD LVCMOS33 } [get_ports { SPI_TX }]; #IO_L2P_T0_34 Sch=ar_mosi_r
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 } [get_ports { SPI_SCK }]; #IO_L19P_T3_35 Sch=sck
...
set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVCMOS33 } [get_ports { UART_RX }]; #IO_L2N_T0_AD8N_35 Sch=rpio_20_r
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { UART_TX }]; #IO_L14P_T2_SRCC_13 Sch=rpio_21_r
